...
def Main():
        ...
        choice = raw_input(" Please choose a valid option (1/2): ")

        if choice == '1':
                message = raw_input(" Please enter your message: ")
                filename = raw_input(" Please select the image in which you wish to encrypt this information: ")
                action = hide(filename, message)
                print action
        elif choice == '2':
                filename = raw_input(" Please select the image from which you wish to decrypt the information: ")
